...
| 变量 | 用途 |
| --- | --- |
| `MYSQL_HOST`、`MYSQL_PORT`、`MYSQL_USERNAME`、`MYSQL_PASSWORD` | 托管 MySQL 连接信息 |
| `REDIS_HOST`、`REDIS_PORT`、`REDIS_PASSWORD` | 托管 Redis 连接信息 |
...
| `PGVECTOR_HOST`、`PGVECTOR_PORT`、`PGVECTOR_USERNAME`、`PGVECTOR_PASSWORD` | PostgreSQL + pgvector 连接信息 |
