...
import org.Lin.ai.model.OrderSummary;
import org.Lin.ai.support.LoggingHook;
import org.Lin.ai.support.ResettableMemorySaver;
import org.Lin.ai.support.SensitiveWordInterceptor;
import org.Lin.ai.tool.OrderTools;
import org.Lin.ai.tool.SessionContextRequest;
import org.Lin.ai.tool.SessionContextTool;
import org.Lin.ai.tool.ShippingPolicyRequest;
...
public class SpringAiAlibabaAgentService {
    ...
    private static final String SIMPLE_AGENT_PROMPT = """
        你是 Lin-RAGAgent 的 Spring AI Alibaba 入门助手。
    ...
    private static final String ORDER_ASSISTANT_PROMPT = """
        你是 Lin-RAGAgent 电商订单助手，需要结合工具结果回答问题。
        你可以：
        1. 查询订单状态和物流信息。
        2. 查询商品详情和售后规则。
