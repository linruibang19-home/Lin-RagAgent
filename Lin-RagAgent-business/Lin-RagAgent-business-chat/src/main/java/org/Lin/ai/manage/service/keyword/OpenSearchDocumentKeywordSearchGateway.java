...
import org.Lin.ai.manage.model.es.DocumentKeywordIndexRecord;
...
public class OpenSearchDocumentKeywordSearchGateway implements DocumentKeywordSearchGateway {

    private final OpenSearchClient elasticsearchClient;
    private final SuperAgentDocumentMapper documentMapper;
    private final DocumentManageProperties properties;

    public OpenSearchDocumentKeywordSearchGateway(
