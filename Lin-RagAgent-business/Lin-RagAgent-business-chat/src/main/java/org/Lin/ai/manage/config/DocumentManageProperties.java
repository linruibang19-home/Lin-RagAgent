...
public class DocumentManageProperties {
    ...
    public static class Kafka {
        private String parseTopic = "Lin-RagAgent-document-parse-route";
        private String indexTopic = "Lin-RagAgent-document-index-build";
        private String groupId = "Lin-RagAgent-document-manage";
