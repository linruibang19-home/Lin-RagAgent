...
import org.Lin.ai.chatagent.rag.service.GraphAnswerRenderer;
import org.Lin.ai.chatagent.rag.service.StructureGraphQueryEngine;
import org.Lin.ai.chatagent.rag.support.ExecutorEventSupport;
import org.Lin.ai.chatagent.service.ConversationTraceRecorder;
import org.Lin.ai.chatagent.service.TaskInfo;
import org.Lin.ai.chatagent.support.StreamEventWriter;
import org.Lin.ai.manage.model.graph.GraphQueryResult;
import org.Lin.ai.manage.model.graph.GraphSectionWithChildren;
import org.Lin.ai.manage.model.graph.GraphSectionWithSiblings;
...
public class GraphOnlyExecutor implements ConversationExecutor {
    ...
    public Flux<String> execute(TaskInfo taskInfo) {
        ...
        if (decision.getNavigationAction() == org.Lin.ai.chatagent.rag.model.DocumentNavigationAction.SECTION_ADJACENCY_LOOKUP) {
